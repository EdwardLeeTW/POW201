...
{
    0x6D97FFFF, // Coefficient A1 will be multiplied with controller output u(n-1)
    0xBF610000, // Coefficient A2 will be multiplied with controller output u(n-2)
    0x95C80002  // Coefficient A3 will be multiplied with controller output u(n-3)
};
